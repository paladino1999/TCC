...
\begin{flushleft}
\textbf{\textsc{Hipótese:}}
\end{flushleft}

	Espera-se que este trabalho contribua para a facilitação do acesso aos meios mais convenientes para o desenvolvimento de JBL, os JBL são mais difíceis de serem desenvolvidos do que os demais gêneros e isso faz com que não exista uma variedade muito boa dos mesmos.
	
\begin{flushleft}
\textbf{\textsc{Método de pesquisa:}}
\end{flushleft}

	É uma pesquisa exploratória utilizando de fontes bibliográficas e experimentais.
